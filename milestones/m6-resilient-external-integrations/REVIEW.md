...
Self-review default client timeouts, retry multiplication, payload/key mismatch, sensitive logs, correlation gaps, swallowed failures, and optimistic success states. Reconstruct C3 using only evidence, then identify the earliest missed signal.
