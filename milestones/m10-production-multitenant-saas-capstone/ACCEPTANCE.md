...
- **A3:** Clean CI runs lint/tests/migrations/security/dependency checks and builds the exact immutable Docker artifact deployed; C3 proves configuration/secrets handling, migration deployment compatibility, readiness gating, failed release rollback/roll-forward, and preserved data.
