...
- **A1:** ER rationale and executable SQL cover relationships; database integration tests prove unique, FK, nullability, and value constraints plus API/application error translation for C1.
...
- **A4:** Request/use-case session scope is explicit; induced flush error rolls back and leaves later work usable; M2 API, integration, migration, lint, and validator commands pass cleanly.
