...
Dependency injection means assembling concrete collaborators at a composition root so code can receive capabilities explicitly. FastAPI dependencies suffice; a DI framework would add indirection without a problem. Services own use-case orchestration/transaction intent; repositories own deliberate persistence operations, not business rules or auto-commit.
