...
- **A2:** C2 proves only earned dependency-injection/service/repository boundaries localize demonstrated orchestration or persistence change; a simple path remains direct, no retained layer merely forwards calls, and the use case owns transaction/invariant intent while repositories do not commit.
