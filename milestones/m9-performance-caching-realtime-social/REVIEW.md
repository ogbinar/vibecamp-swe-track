...
Self-review tiny/unskewed data, benchmark drift, omitted errors, warmed-only claims, cross-user cache keys, stale authorization, stampedes, unbounded live buffers, and semantic changes disguised as optimization.
